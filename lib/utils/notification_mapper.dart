...
class NotificationMapper {
  ...
  static NotificationItem? mapToNotificationItem(Map<String, dynamic> notification) {
    try {
      ...
      switch (notificationType) {
        ...
        case 'wod_selected':
          item = _mapWodSelected(data, title, body, timestamp, isRead, tileBackgroundColor);
          break;
      ...
      final mappedItem = NotificationItem(
        ...
        avatarSvgSize: item.avatarSvgSize,
  ...
  static NotificationItem _mapPostHot(
    ...
    return NotificationItem(
      ...
      unread: !isRead,
      tileBackgroundColor: tileBackgroundColor,
      avatarBackground: Colors.transparent,
      avatarSvgAsset: 'assets/notis/hottest-post-notification.svg',
      avatarSvgSize: 47,
  ...
  static NotificationItem _mapPostTop(
    ...
    return NotificationItem(
      ...
      tileBackgroundColor: tileBackgroundColor,
      avatarBackground: Colors.transparent,
      avatarSvgAsset: 'assets/notis/Top-Post-Notification.svg',
      avatarSvgSize: 47,
      avatarIconColor: null,
      notificationData: null,
    );
  ...
  static NotificationItem _mapWodSelected(
    Map<String, dynamic> data,
    String title,
    String body,
    String timestamp,
    ...
    return NotificationItem(
      ...
      tileBackgroundColor: tileBackgroundColor,
      avatarBackground: Colors.transparent,
      avatarSvgAsset: 'assets/notis/WOD-notification-icon.svg',
      avatarSvgSize: 47,
      avatarIconColor: null,
      notificationData: null,
    );
  ...
  static NotificationItem _mapReportStatus(
    ...
    return NotificationItem(
      ...
      tileBackgroundColor: tileBackgroundColor,
      avatarBackground: Colors.transparent,
      avatarSvgAsset: 'assets/notis/Report-under-review-notification.svg',
      avatarSvgSize: 47,
      avatarIconColor: null,
      notificationData: null,
    );
