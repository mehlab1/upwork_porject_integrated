...
class _EditPostScreenState extends State<EditPostScreen> {
  ...
  Widget _buildHeader(BuildContext context) {
    ...
    final username = widget.postData?.username ?? 'User';
    final timeAgo = widget.postData?.timeAgo ?? '';
    final profilePictureUrl = widget.postData?.profilePictureUrl;
    final initials = widget.postData?.initials ?? username[0].toUpperCase();
  ...
  void _handleSubmit() async {
    ...
    try {
      final response = await _postService.adminEditPost(
...
class _LocationDropdownContent extends StatefulWidget {
  ...
  @override
  State<_LocationDropdownContent> createState() =>
...
/// Show the edit post modal dialog, matching the create post UI.
Future<bool?> showEditPostModal(
