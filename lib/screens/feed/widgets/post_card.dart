...
class _CommentInputFieldState extends State<_CommentInputField> {
  ...
  Future<void> _searchUsers(String query) async {
    try {
      // Search with query - increased limit to 20 to show more users
      final response = await _postService.searchUsers(query: query, limit: 20);
  ...
  void _selectMention(ProfileData user) {
    ...
    // Restore focus to the text field after selection
              ...
              if (_showMentionSuggestions && _mentionSuggestions.isNotEmpty)
                Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: List.generate(_mentionSuggestions.length, (index) {
