...
class DeleteCommentResult {
  const DeleteCommentResult({required this.confirmed});

  final bool confirmed;
}

class DeleteCommentDialog extends StatelessWidget {
  const DeleteCommentDialog({super.key, required this.commentPreview});
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      onPressed: () => Navigator.of(context)
                          .pop(const DeleteCommentResult(confirmed: false)),
                      child: const Text(
                        'Cancel',
                        style: TextStyle(
                          fontSize: 14,
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () => Navigator.of(context)
                          .pop(const DeleteCommentResult(confirmed: true)),
                      child: Row(
