...
class DeletePostResult {
  const DeletePostResult({required this.confirmed});

  final bool confirmed;
}

class DeletePostDialog extends StatelessWidget {
  const DeletePostDialog({super.key, required this.postTitle});
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      onPressed: () =>
                          Navigator.of(context).pop(const DeletePostResult(confirmed: false)),
                      child: const Text(
                        'Cancel',
                        style: TextStyle(
                          fontSize: 14,
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () =>
                          Navigator.of(context).pop(const DeletePostResult(confirmed: true)),
                      child: Row(
