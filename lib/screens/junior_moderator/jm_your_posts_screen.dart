...
class JmYourPostsScreen extends StatefulWidget {
  const JmYourPostsScreen({super.key});

  static const routeName = '/settings/your-posts';

  @override
  State<JmYourPostsScreen> createState() => _JmYourPostsScreenState();
}

class _JmYourPostsScreenState extends State<JmYourPostsScreen> {
