...
class JmNotificationsScreen extends StatefulWidget {
  const JmNotificationsScreen({super.key});

  @override
  State<JmNotificationsScreen> createState() => _JmNotificationsScreenState();
}

class _JmNotificationsScreenState extends State<JmNotificationsScreen> {
  ...
  Future<void> _markAllNotificationsAsRead() async {
    try {
      ...
      debugPrint(
        '[JmNotificationsScreen] Error marking all notifications as read: $e',
      );
    }
  }
  ...
  Future<void> _loadNotifications() async {
    ...
    try {
      ...
      debugPrint('[JmNotificationsScreen] Error loading notifications: $e');
      if (!mounted) return;
      setState(() {
        _isPageLoading = false;
      });
