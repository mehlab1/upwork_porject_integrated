...
class JmBlockUserResult {
  const JmBlockUserResult({required this.confirmed});

  final bool confirmed;
}

class JmBlockUserDialog extends StatelessWidget {
  const JmBlockUserDialog({super.key, required this.username});
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      onPressed: () => Navigator.of(context).pop(
                        const JmBlockUserResult(confirmed: false),
                      ),
                      child: const Text(
                        'Cancel',
                        style: TextStyle(
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () => Navigator.of(context).pop(
                        const JmBlockUserResult(confirmed: true),
                      ),
                      child: const Text(
                        'Block',
                        style: TextStyle(
