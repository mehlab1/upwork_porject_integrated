...
class JmDeletePostResult {
  const JmDeletePostResult({required this.confirmed});

  final bool confirmed;
}

class JmDeletePostDialog extends StatelessWidget {
  const JmDeletePostDialog({super.key, required this.postTitle});
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      onPressed: () =>
                          Navigator.of(context).pop(const JmDeletePostResult(confirmed: false)),
                      child: const Text(
                        'Cancel',
                        style: TextStyle(
                          fontSize: 14,
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () =>
                          Navigator.of(context).pop(const JmDeletePostResult(confirmed: true)),
                      child: Row(
