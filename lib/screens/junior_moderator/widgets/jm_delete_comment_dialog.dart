...
class JmDeleteCommentResult {
  const JmDeleteCommentResult({required this.confirmed});

  final bool confirmed;
}

class JmDeleteCommentDialog extends StatelessWidget {
  const JmDeleteCommentDialog({super.key, required this.commentPreview});
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      onPressed: () => Navigator.of(context)
                          .pop(const JmDeleteCommentResult(confirmed: false)),
                      child: const Text(
                        'Cancel',
                        style: TextStyle(
                          fontSize: 14,
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () => Navigator.of(context)
                          .pop(const JmDeleteCommentResult(confirmed: true)),
                      child: Row(
