...
import 'jm_your_posts_screen.dart';
import 'jm_community_guidelines_screen.dart';
import 'jm_faq_screen.dart';
import 'jm_blocked_accounts_screen.dart';
import 'jm_junior_moderator_queue_screen.dart';
import 'jm_content_curator_queue_screen.dart';
...
import 'jm_upvoted_posts_screen.dart';

class JmSettingsScreen extends StatefulWidget {
  const JmSettingsScreen({super.key});

  @override
  State<JmSettingsScreen> createState() => _JmSettingsScreenState();
}
...
class _JmSettingsScreenState extends State<JmSettingsScreen> {
  ...
  Future<void> _checkAdminAndNavigate() async {
    // Junior moderator settings - no redirect needed, this IS the JM settings screen
  }
                            ...
                            _SettingsTileData(
                              ...
                              onTap: () {
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        const JmJuniorModeratorQueueScreen(),
                                  ),
                                );
                              },
                            ),
                            _SettingsTileData(
                              ...
                              onTap: () {
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        const JmContentCuratorQueueScreen(),
                                  ),
                                );
                              },
                            ),
                            ...
                            _SettingsTileData(
                              ...
                              onTap: _hasUpvotedPosts
                                  ? () {
                                      ...
                                      Navigator.pushNamed(
                                        context,
                                        JmUpvotedPostsScreen.routeName,
                                      );
                                    }
                                  : null,
                            ),
                            ...
                            _SettingsTileData(
                              ...
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        const JmCommunityGuidelinesScreen(),
                                  ),
                                );
                              },
                            ),
                      ...
                      Container(
                        ...
                        decoration: const BoxDecoration(
                          ...
                          gradient: LinearGradient(
                            colors: [Color(0xFFF4119E), Color(0xFF4A313E)],
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: const [
                          // Approximate the second dark overlay gradient with a soft shadow
                          BoxShadow(
