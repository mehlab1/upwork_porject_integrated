...
class JmFaqScreen extends StatefulWidget {
  const JmFaqScreen({super.key});

  static const routeName = '/settings/faq';

  @override
  State<JmFaqScreen> createState() => _JmFaqScreenState();
}

class _JmFaqScreenState extends State<JmFaqScreen> {
