...
class JmPostDetailScreen extends StatefulWidget {
  const JmPostDetailScreen({
    super.key,
  ...
  @override
  State<JmPostDetailScreen> createState() => _JmPostDetailScreenState();
}

class _JmPostDetailScreenState extends State<JmPostDetailScreen> {
  ...
  JmPostCardData? _postData;
  
  // In-memory cache for post data (simple cache)
  static final Map<String, JmPostCardData> _postCache = {};
  ...
  Future<JmPostCardData?> _mapPostResponseToCardData(
