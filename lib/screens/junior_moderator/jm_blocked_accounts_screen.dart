...
class JmBlockedAccountsScreen extends StatefulWidget {
  const JmBlockedAccountsScreen({super.key});

  static const routeName = '/settings/blocked-accounts';

  @override
  State<JmBlockedAccountsScreen> createState() => _JmBlockedAccountsScreenState();
}

class _JmBlockedAccountsScreenState extends State<JmBlockedAccountsScreen> {
