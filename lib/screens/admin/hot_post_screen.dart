...
class _HotPostScreenState extends State<HotPostScreen> {
  ...
  Future<void> _loadHotPost() async {
    try {
      ...
      // in-flight request that was kicked off by prefetchHotPost() during navigation.
...
// ── Skeleton shown while Hot Post data is loading ──────────────────────────
class _HotPostSkeleton extends StatelessWidget {
  const _HotPostSkeleton();
