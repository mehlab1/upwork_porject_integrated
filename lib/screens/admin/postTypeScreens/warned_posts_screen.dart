...
class WarnedPostsScreen extends StatefulWidget {
  const WarnedPostsScreen({super.key});

  @override
  State<WarnedPostsScreen> createState() => _WarnedPostsScreenState();
}

class _WarnedPostsScreenState extends State<WarnedPostsScreen> {
