...
//     String?
//     actionType, // 'shadow_ban', 'suspended', 'banned' (only for resolved)
//   }) {
//     return Container(
//       decoration: BoxDecoration(
//         color: Colors.white,
//         borderRadius: BorderRadius.circular(14),
//         border: Border(
//           bottom: BorderSide(color: const Color(0xFFE2E8F0), width: 0.756),
//         ),
//         boxShadow: const [
//           BoxShadow(
...
class ModeratorQueueScreen extends StatefulWidget {
  ...
  @override
  State<ModeratorQueueScreen> createState() =>
      _ModeratorQueueScreenState();
}

class _ModeratorQueueScreenState
    extends State<ModeratorQueueScreen> {
