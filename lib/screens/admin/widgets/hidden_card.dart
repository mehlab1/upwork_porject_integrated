...
enum AdminPostType { hidden, warned, muted, duplicated, reported, flagged }
...
class HiddenCard extends StatefulWidget {
  const HiddenCard({
    ...
    this.initials = 'U',
    this.profileColor = const Color(0xFFF1F5F9), // Default avatar background
    this.type = AdminPostType.hidden,
  });
...
class _HiddenCardState extends State<HiddenCard> {
  ...
  static const Color _primary900 = Color(0xFF100B3C); // Primary/900
  static const Color _textBody = Color(0xFF45556C); // Body text
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      runSpacing: 6,
                      children: [
                        _buildBadge(widget.location, icon: 'assets/adminIcons/adminPostTypes/locationIcon.svg'),
                        _buildBadge(widget.category, icon: 'assets/adminIcons/adminPostTypes/commentIcon.svg', isHighlight: true),
                        _buildTypeBadge(),
                      ],
                    ),
                  ],
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Icon(Icons.arrow_upward_rounded, size: 18, color: _textBody),
                    ...
                    const SizedBox(height: 12),
                    const Icon(Icons.arrow_downward_rounded, size: 18, color: _textBody),
                  ],
                ),
              ),
            ],
  ...
  Widget _buildTypeBadge() {
    ...
    switch (widget.type) {
      case AdminPostType.warned:
        text = 'Warned Post';
        iconPath = 'assets/adminIcons/adminPostTypes/warning.svg';
        bg = const Color(0xFFFEFED6);
        content = const Color(0xFFB45309); // Keeping readable brown (Yellow text is bad)
        borderColor = const Color(0xFFF4F43D);
        break;
      case AdminPostType.muted:
        text = 'Muted Post';
