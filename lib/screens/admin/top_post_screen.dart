...
// class TopPostScreen extends StatefulWidget {
//   const TopPostScreen({super.key});

//   @override
//   State<TopPostScreen> createState() => _TopPostScreenState();
// }

// class _TopPostScreenState extends State<TopPostScreen> {
//   @override
...
class _TopPostScreenState extends State<TopPostScreen> {
  ...
  Future<void> _fetchTopPost() async {
    ...
    try {
      // Use AppCache — returns cached data on revisit, or waits for the
      // in-flight request that was kicked off by prefetchTopPost() during navigation.
            ...
            Expanded(
              child: _isLoading
                  ...
                  : _error != null
                      ...
                      : topPost == null
                          ? const Center(child: Text("No top post available"))
...
// ── Skeleton shown while Top Post data is loading ──────────────────────────
class _TopPostSkeleton extends StatelessWidget {
  const _TopPostSkeleton();
