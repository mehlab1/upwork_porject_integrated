...
// class JuniorModeratorQueueScreen extends StatefulWidget {
//   const JuniorModeratorQueueScreen({super.key});

//   @override
//   State<JuniorModeratorQueueScreen> createState() =>
//       _JuniorModeratorQueueScreenState();
// }

// class _JuniorModeratorQueueScreenState
//     extends State<JuniorModeratorQueueScreen> {
...
class _JuniorModeratorQueueScreenState
  ...
  // ⚡ Keep your existing _buildPostCard and _buildCommentCard here
  // (No changes required, just copy-paste from your original)
  Widget _buildPostCard({
  required String username,
  required String timeAgo,
  required String initials,
