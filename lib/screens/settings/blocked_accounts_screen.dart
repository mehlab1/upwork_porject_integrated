  ...
  Future<void> _loadBlockedUsers() async {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        setState(() {
          _errorMessage = response['message']?.toString() ?? 'Failed to load blocked users';
          _isLoading = false;
        });
      }
    } catch (e) {
  ...
  Future<void> _unblockUser(String userId, String username) async {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        setState(() {
          _blockedUsers.removeWhere((user) => 
            user['id'] == userId || user['blocked_user_id'] == userId);
          _unblockingUsers.remove(userId);
        });

        PalToast.show(
          context,
          message: 'You\'ve unblocked $username. You\'ll be able to see each other\'s posts and interact again.',
        );
      } else {
        setState(() {
          _unblockingUsers.remove(userId);
      ...
      PalToast.show(
        context,
        message: 'Failed to unblock user: ${e.toString().replaceFirst('Exception: ', '')}',
      );
    }
  }
                        ...
                        builder: (context, constraints) {
                          ...
                          return SingleChildScrollView(
                            ...
                            child: Column(
                              ...
                              children: [
                                // About Blocking Card
                                _AboutBlockingCard(isSmallScreen: isSmallScreen, isLargeScreen: isLargeScreen),
                                SizedBox(height: isSmallScreen ? 16 : isLargeScreen ? 32 : 24),
                            // Content: Empty state or blocked users list
                            _blockedUsers.isEmpty
                                ? _EmptyStateCard(isSmallScreen: isSmallScreen, isLargeScreen: isLargeScreen)
                                : Column(
                                    crossAxisAlignment: CrossAxisAlignment.stretch,
                                    children: [
                                      ..._blockedUsers.map((user) {
                                        final userId = user['blocked_user_id']?.toString() ?? 
                                                      user['id']?.toString() ?? '';
                                        final username = user['blocked_username']?.toString() ?? 
                                                        user['username']?.toString() ?? '@user';
                                        final profilePictureUrl = user['blocked_profile_picture_url']?.toString() ??
                                                                 user['profile_picture_url']?.toString();
                                        final blockedAt = user['blocked_at']?.toString();
                                        final initials = _getInitials(username);
                                        final isUnblocking = _unblockingUsers.contains(userId);
                                        ...
                                        return Padding(
                                          ...
                                          child: _BlockedUserItem(
                                            ...
                                            onUnblock: isUnblocking ? null : () => _unblockUser(userId, username),
...
class _BlockedAccountsHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fontSize = isSmallScreen ? 18.0 : isLargeScreen ? 22.0 : 20.0;
    final horizontalPadding = isSmallScreen ? 8.0 : isLargeScreen ? 16.0 : 8.0;
...
class _AboutBlockingCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final iconSize = isSmallScreen ? 18.0 : isLargeScreen ? 22.0 : 20.0;
    final iconContainerSize = isSmallScreen ? 36.0 : isLargeScreen ? 44.0 : 40.0;
    final titleFontSize = isSmallScreen ? 15.0 : isLargeScreen ? 17.0 : 16.0;
    final bodyFontSize = isSmallScreen ? 13.0 : isLargeScreen ? 15.0 : 14.0;
    final cardPadding = isSmallScreen ? 12.0 : isLargeScreen ? 20.0 : 16.0;
    final spacing = isSmallScreen ? 12.0 : isLargeScreen ? 18.0 : 14.0;
...
class _EmptyStateCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final iconContainerSize = isSmallScreen ? 70.0 : isLargeScreen ? 90.0 : 80.0;
    final iconSize = isSmallScreen ? 32.0 : isLargeScreen ? 40.0 : 36.0;
    final titleFontSize = isSmallScreen ? 15.0 : isLargeScreen ? 17.0 : 16.0;
    final bodyFontSize = isSmallScreen ? 13.0 : isLargeScreen ? 15.0 : 14.0;
    final cardHeight = isSmallScreen ? 300.0 : isLargeScreen ? 400.0 : 352.0;
    final spacing = isSmallScreen ? 48.0 : isLargeScreen ? 80.0 : 64.0;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: isSmallScreen ? 8 : isLargeScreen ? 24 : 0),
              child: Text(
...
class _BlockedUserItem extends StatelessWidget {
  ...
  String _formatBlockedDate(String? blockedAt) {
    ...
    try {
      ...
      if (difference.inDays == 0) {
        ...
        return months == 1 ? 'Blocked 1 month ago' : 'Blocked $months months ago';
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    final avatarSize = isSmallScreen ? 42.0 : isLargeScreen ? 52.0 : 47.0;
    final badgeFontSize = isSmallScreen ? 13.0 : isLargeScreen ? 15.0 : 14.0;
    final dateFontSize = isSmallScreen ? 13.0 : isLargeScreen ? 15.0 : 14.0;
    final buttonFontSize = isSmallScreen ? 13.0 : isLargeScreen ? 15.0 : 14.0;
    ...
    final usernameFontSize = isUsernameTooLong 
        ? (isSmallScreen ? 11.0 : isLargeScreen ? 13.0 : 12.0)
        : badgeFontSize;
    final cardPadding = isSmallScreen ? 16.0 : isLargeScreen ? 24.0 : 20.0;
    final spacing = isSmallScreen ? 12.0 : isLargeScreen ? 20.0 : 16.0;
    final buttonHeight = isSmallScreen ? 24.0 : isLargeScreen ? 30.0 : 26.0;
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                          ...
                          ClipRRect(
                            ...
                            child: Container(
                              padding: EdgeInsets.symmetric(
                                horizontal: isSmallScreen ? 8 : isLargeScreen ? 11 : 9.47,
                                vertical: isSmallScreen ? 2.5 : isLargeScreen ? 4 : 3.47,
                              ),
                              decoration: BoxDecoration(
                    ...
                    isUnblocking
                        ? SizedBox(
                            width: isSmallScreen ? 80 : isLargeScreen ? 95 : 85,
                            height: buttonHeight,
                            child: Center(
                              child: SizedBox(
                            ...
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                child: IntrinsicWidth(
                                  child: Container(
                                    padding: EdgeInsets.symmetric(
                                      horizontal: isSmallScreen ? 14 : isLargeScreen ? 22 : 18,
                                      vertical: isSmallScreen ? 6 : isLargeScreen ? 10 : 8,
                                    ),
                                    height: buttonHeight,
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(8),
