...
class ModeratorUserProfileScreen extends StatefulWidget {
  const ModeratorUserProfileScreen({
    super.key,
  ...
  @override
  State<ModeratorUserProfileScreen> createState() => _ModeratorUserProfileScreenState();
}

class _ModeratorUserProfileScreenState extends State<ModeratorUserProfileScreen> {
          ...
          : PalBottomNavigationBar(
              ...
              onSettingsTap: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => const ModeratorSettingsScreen(),
                  ),
                );
              },
            ),
