            ...
            LayoutBuilder(
              builder: (context, constraints) {
                return SingleChildScrollView(
                  child: Column(
                    children: [
                      SizedBox(height: Responsive.heightPercent(context, 25)),
                      ...
                      SizedBox(height: Responsive.heightPercent(context, 10)), // Space to email field
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(Responsive.responsiveRadius(context, 10)),
                                ),
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          contentPadding: Responsive.responsiveSymmetric(
                                            context,
                                            vertical: 19,
                                          ),
                                        ),
                              ...
                              if (_emailError != null)
                                Padding(
                                  padding: Responsive.responsivePadding(context, top: 4),
                                  child: Row(
                                    children: [
                                      Icon(
                                        Icons.error_outline,
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(Responsive.responsiveRadius(context, 11)),
                                ),
                                child: Row(
                                  children: [
                                    SizedBox(width: Responsive.scaledPadding(context, 20)),
                          ...
                          child: Row(
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  width: Responsive.scaledPadding(context, 24.4),
                      ...
                      SizedBox(height: Responsive.scaledPadding(context, 40)),
