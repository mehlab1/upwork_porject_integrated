...
class ReviewerYourPostsScreen extends StatefulWidget {
  const ReviewerYourPostsScreen({super.key});

  static const routeName = '/settings/your-posts';

  @override
  State<ReviewerYourPostsScreen> createState() => _JmYourPostsScreenState();
}

class _JmYourPostsScreenState extends State<ReviewerYourPostsScreen> {
