...
class ReviewerUserProfileScreen extends StatefulWidget {
  const ReviewerUserProfileScreen({
    super.key,
  ...
  @override
  State<ReviewerUserProfileScreen> createState() => _JmUserProfileScreenState();
}

class _JmUserProfileScreenState extends State<ReviewerUserProfileScreen> {
          ...
          : PalBottomNavigationBar(
              ...
              onSettingsTap: () {
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => const ReviewerSettingsScreen(),
                  ),
                );
              },
            ),
