...
class ReviewerBlockUserResult {
  const ReviewerBlockUserResult({required this.confirmed});

  final bool confirmed;
}

class ReviewerBlockUserDialog extends StatelessWidget {
  const ReviewerBlockUserDialog({super.key, required this.username});
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      onPressed: () => Navigator.of(context).pop(
                        const ReviewerBlockUserResult(confirmed: false),
                      ),
                      child: const Text(
                        'Cancel',
                        style: TextStyle(
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () => Navigator.of(context).pop(
                        const ReviewerBlockUserResult(confirmed: true),
                      ),
                      child: const Text(
                        'Block',
                        style: TextStyle(
