...
class ReviewerReportPostSheet extends StatefulWidget {
  const ReviewerReportPostSheet({super.key, this.subject = ReportSubject.post});

  final ReportSubject? subject;

  @override
  State<ReviewerReportPostSheet> createState() => _JmReportPostSheetState();
}

class _JmReportPostSheetState extends State<ReviewerReportPostSheet> {
...
class ReviewerReportSuccessDialog extends StatelessWidget {
  const ReviewerReportSuccessDialog({super.key});
