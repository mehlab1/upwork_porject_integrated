...
const _quoteBackground = Color(0xFFF8FAFC);
const _quoteBorder = Color(0xFFE2E8F0);
const _quoteText = Color(0xFF314158);
...
class ReviewerDeletePostResult {
  const ReviewerDeletePostResult({required this.confirmed});

  final bool confirmed;
}

class ReviewerDeletePostDialog extends StatelessWidget {
  const ReviewerDeletePostDialog({super.key, required this.postTitle});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Are you sure you want to delete this post? All comments and votes will be permanently removed.',
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w400,
                  color: _bodyColor,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _quoteBackground,
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(color: _quoteBorder, width: 0.756),
                ),
                child: Text(
                  '"$postTitle"',
                ...
                child: RichText(
                  text: const TextSpan(
                    ...
                    children: [
                      TextSpan(
                        text:
                            'This will permanently delete your post from the feed.',
                        style: TextStyle(
                          fontWeight: FontWeight.w400,
                        ),
                      ),
                ...
                children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      onPressed: () =>
                          Navigator.of(context).pop(const ReviewerDeletePostResult(confirmed: false)),
                      child: const Text(
                        'Cancel',
                        style: TextStyle(
                          fontSize: 14,
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () =>
                          Navigator.of(context).pop(const ReviewerDeletePostResult(confirmed: true)),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          SvgPicture.asset(
                            _deleteButtonIconAsset,
                            width: 16,
                            height: 16,
                            colorFilter: const ColorFilter.mode(
                              Colors.white,
