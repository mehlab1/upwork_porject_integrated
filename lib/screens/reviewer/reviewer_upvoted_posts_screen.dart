...
class ReviewerUpvotedPostsScreen extends StatefulWidget {
  const ReviewerUpvotedPostsScreen({super.key});

  static const routeName = '/settings/upvoted-posts';

  @override
  State<ReviewerUpvotedPostsScreen> createState() => _JmUpvotedPostsScreenState();
}

class _JmUpvotedPostsScreenState extends State<ReviewerUpvotedPostsScreen> {
  final PostService _postService = PostService();
  final ProfileService _profileService = ProfileService();

  List<ReviewerPostCardData> _posts = [];
  ...
  bool _postsSnapshotChanged(
    List<ReviewerPostCardData> nextPosts,
    int nextTotal,
  ) {
  ...
  ReviewerPostCardData? _mapPostToCardData(Map<String, dynamic> post) {
