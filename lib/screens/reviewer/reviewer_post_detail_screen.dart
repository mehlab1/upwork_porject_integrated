...
class ReviewerPostDetailScreen extends StatefulWidget {
  const ReviewerPostDetailScreen({
    super.key,
  ...
  @override
  State<ReviewerPostDetailScreen> createState() => _JmPostDetailScreenState();
}

class _JmPostDetailScreenState extends State<ReviewerPostDetailScreen> {
  ...
  ReviewerPostCardData? _postData;
  
  // In-memory cache for post data (simple cache)
  static final Map<String, ReviewerPostCardData> _postCache = {};
  ...
  Future<ReviewerPostCardData?> _mapPostResponseToCardData(
