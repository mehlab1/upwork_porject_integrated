...
import 'reviewer_your_posts_screen.dart';
import 'reviewer_community_guidelines_screen.dart';
import 'reviewer_faq_screen.dart';
import 'reviewer_blocked_accounts_screen.dart';
import 'reviewer_content_curator_queue_screen.dart';
import 'reviewer_wod_screen.dart';
...
import 'reviewer_upvoted_posts_screen.dart';
import 'package:pal/services/app_cache.dart';

class ReviewerSettingsScreen extends StatefulWidget {
  const ReviewerSettingsScreen({super.key});

  @override
  State<ReviewerSettingsScreen> createState() => _JmSettingsScreenState();
}

class _JmSettingsScreenState extends State<ReviewerSettingsScreen> {
  ...
  Future<void> _checkAdminAndNavigate() async {
    // Reviewer settings - no redirect needed, this IS the reviewer settings screen
  }
  ...
  Future<void> _showDeactivateAccountDialog(BuildContext context) async {
    ...
    if (result == true && mounted) {
      ...
      try {
        ...
        // Clear admin and reviewer status on deactivation
  ...
  Future<void> _showLogoutDialog(BuildContext context) async {
    ...
    if (result == true && mounted) {
      ...
      try {
        ...
        // Clear admin and reviewer status on logout
        await _adminService.clearAdminStatus();
        await _ReviewerService.clearReviewerStatus();
                            ...
                            _SettingsTileData(
                              ...
                              onTap: () {
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        const ReviewerContentCuratorQueueScreen(),
                                  ),
                                );
                              },
                            ),
                            ...
                            _SettingsTileData(
                              ...
                              onTap: _hasUpvotedPosts
                                  ? () {
                                      ...
                                      Navigator.pushNamed(
                                        context,
                                        ReviewerUpvotedPostsScreen.routeName,
                                      );
                                    }
                                  : null,
                            ),
                            ...
                            _SettingsTileData(
                              ...
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        const ReviewerCommunityGuidelinesScreen(),
                                  ),
                                );
                              },
                            ),
                            ...
                            _SettingsTileData(
                              ...
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => const ReviewerFaqScreen(),
                                  ),
                                );
                              },
                            ),
                            ...
                            _SettingsTileData(
                              ...
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        const ReviewerBlockedAccountsScreen(),
                                  ),
                                );
                              },
                            ),
                  ...
                  children: [
                    if (isLoading)
                      ...
                      Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(3.79),
                      ...
                      child: Row(
                        ...
                        children: [
                          svg.SvgPicture.asset(
                            'assets/Rev_Icons/reviewer-badge-icon.svg',
                            width: 12,
                            height: 12,
                          ),
            ...
            child: OutlinedButton.icon(
              onPressed: () async {
                final result = await Navigator.pushNamed(
                  context,
                  ReviewerYourPostsScreen.routeName,
                );
